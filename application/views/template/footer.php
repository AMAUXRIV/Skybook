        ...
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?= base_url('welcome/tentang') ?>">Tentang Skybook</a></li>
                        <li><a href="<?= base_url('welcome/materi') ?>">Materi Skybook</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak Skybook</a></li>
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    <h6 class="footer_title">Materi Pembelajaran</h6>
                    <ul class="list">
                        <li><a href="javaScript:void(0);">Zat Makanan</a></li>
                        <li><a href="javaScript:void(0);">Saluran dan Kelenjar Pencernaan Makanan</a></li>
                        <li><a href="javaScript:void(0);">Kelainan dan Gangguan Pada Sistem Pencernaan</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang Skybook</h4>
                <p>
                    Web Edukasi Open Source yang dibuat oleh Lusi Elsa Maylana. Skybook adalah Web edukasi yang dilengkapi video, materi dan sistem ujian serta quiz yang tersedia secara gratis. Skybook dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" col-md-6">
                            <form action="<?= base_url('welcome/validateLogin') ?>" method="post">
                                ...
                                <button class="btn btn-block font-weight-bold" style="background-color: #03A2FF;color:white;font-size:18px;">Login
                                    Sekarang!</button>
                            </form>
                        </div>
                    </div>
