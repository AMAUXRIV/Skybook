...
<head>
    ...
    <meta content="Skybook dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja." name="Description" />
    <meta content="Skybook, E-learning, Open Source, Syauqi Zaidan Khairan Khalaf, github, programmer indonesia" name="keywords" />
    <link rel="icon" href="<?= base_url('assets/') ?>img/new/SB4.png" type="image/png">
    <title>Skybook - Belajar Dimana Saja & Kapan Saja !</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    <a class="dn_btn" href="mailto:lusielsa94@gmail.com">lusielsa94@gmail.com</a>
                </div>
            </div>
        </div>
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="<?= base_url('welcome') ?>"><img src="<?= base_url('assets/') ?>img/new/SB4.png" alt="" width="80px" style="margin-top: -5px;"></a>
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent" style="margin-top: -5px; ">
