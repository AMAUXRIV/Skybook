...
<head>
    <meta charset="utf-8" />
    <title>Skybook - Teacher Page</title>
    ...
    <!--end::Layout Skins -->
    <link rel="shortcut icon" href="<?=base_url('assets')?>/img/new/SB4.png" />
    ...
    <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
        <div class="kt-header-mobile__logo">
            <a class="navbar-brand logo_h" href="<?=base_url('guru/add_materi')?>">
                <img alt="Logo" src="<?=base_url('assets')?>/img/new/SB3.png" width="90x;" />
            </a>
        </div>
                ...
                <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                    <div class="kt-aside__brand-logo">
                        <a href="<?=base_url('guru')?>">
                            <img alt="Logo" width="50px;" src="<?=base_url('assets')?>/img/new/SB4.png" />
                        </a>
                    </div>
                </div>
                                            ...
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                                    ...
                                                    href="<?=base_url('guru/data_quiz')?>" class="kt-menu__link "><i
                                                        ...
                                                        class="kt-menu__link-text">Data Quiz</span></a></li>
                                                         ...
                                                         <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="<?=base_url('guru/jawaban_quiz')?>" class="kt-menu__link "><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                                        class="kt-menu__link-text">Jawaban Quiz</span></a></li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
                                    ...
                                    <div class="kt-portlet__body kt-portlet__body--fit">
                                        <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides">
                                            <img src="<?=base_url('assets/')?>img/user.png" class=" img-fluid" alt=""
                                                srcset="">
                                            <h1 class="kt-widget19__title kt-font-light display-6 font-weight-bold"
...
?> !
                                            ...
                                            <div class="kt-widget19__labels">
                                                <a href="#" class="btn btn-label-light-o2 btn-bold btn-sm ">Skybook</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kt-portlet__body">
                                        <div class="kt-widget19__wrapper">
                                            ...
                                            <div class="kt-widget19__text">
                                                Selamat datang di halaman guru Skybook, anda dapat menambah materi .
                                                Dalam materi anda dapat memasukan video, dan deskripsi nya. Seemoga anda
                                                dapat menikmati Skybook!, kontak Administrator jika terjadi masalah
                                        ...
                                        <div class="kt-widget19__action">
                                            ...
                                            <a href="<?=base_url('guru/add_quiz')?>" class="btn btn-sm btn-label-brand btn-bold">Tambah Quiz</a>
                                        </div>
                                    </div>
                                </div>
