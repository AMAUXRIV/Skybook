...
<head>
    ...
    <title>Tambah Data Guru - Skybook</title>
    <!-- General CSS Files -->
                    ...
                    <div id="detail" class="card card-success">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?= base_url('admin/add_guru') ?>">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-infobtn-lg btn-block">
                                        Daftar ⭢
                                    </button>
                                </div>
...
Copyright &copy; 2024 <div class="bullet"></div><a href="https://birojasaceeria.my.id">Skybook</a>
        </div>
    </footer>
    <!-- End Footer -->
