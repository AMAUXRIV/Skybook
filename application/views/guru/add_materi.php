    ...
    <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
        <div class="kt-header-mobile__logo">
            <a href="<?=base_url('guru')?>">
                <img alt="Logo" src="<?=base_url('assets')?>/img/new/SB3.png" width="90px;" />
            </a>
        </div>
...
echo $data['user']['nama_mapel'];?>" class="form-control" id="inputEmail4">
 ...
 <div class="form-group">
                                                    <label for="exampleFormControlInput1">Link PPT</label>
                                                    <input type="text" name="link_ppt" id="link_ppt" class="form-control" require>
