    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mx-auto mt-4">
               ...
               if ($detail->jenis_file == 'foto'): ?>
                <!-- Displaying a photo -->
                <img src="<?= base_url() . 'assets/materi_video/' . $detail->foto; ?>" alt="Photo" class="img-fluid">
            <?php elseif ($detail->jenis_file == 'video'): ?>
                <!-- Displaying a video -->
        ...
        <div class="row mt-4">
            <div class="col-md-12 w-150 mb-4">
                <div class="card materi border-0">
                    <div class="card-body p-5 card-title-container">
                         <a href="<?= $detail->link_ppt ?>" target="_blank" class="btn btn-primary download-btn"><i class="fa fa-file-powerpoint-o" aria-hidden="true"></i>  PPT</a>

                <h1 class="card-title"><?= $detail->nama_guru; ?></h1>
