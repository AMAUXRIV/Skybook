...
<head>
    ...
    <title>Biologi | Kelas XII - Skybook</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="col-md-6 mb-4" data-aos="fade-right" data-aos-duration="1200">
        <div class="card materi w-150 border-0">
            <div class="card-body p-5 card-title-container">
                <!-- Download PPT button in the top right corner of the card title -->
                <a href="<?= $u->link_ppt ?>" target="_blank" class="btn btn-primary download-btn"><i class="fa fa-file-powerpoint-o" aria-hidden="true"></i>  PPT</a>
