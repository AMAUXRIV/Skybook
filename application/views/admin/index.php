                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">Tugas Admin adalah menjaga dan mengatur semua data termasuk materi yang akan ditambah ,tolong berhati-hati dengan data yang akan diinputkan.</p>
                                <a href="<?= base_url('admin/tambah_materi') ?>" class="btn btn-info">Tambah Materi ⭢</a>
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg">
                            <div class=" hero-inner">
                                <h1>Selamat Datang, <?php
                                                    ...
                                                    ?>!</h1>
                                <p class="lead">Tugas Admin adalah menjaga dan mengatur semua data termasuk materi yang akan ditambah ,tolong berhati-hati dengan data yang akan diinputkan.</p>
                                <div class="mt-4">
