    ...
    <div class="banner_inner d-flex align-items-center">
        ...
        <div class="container">
            <div class="banner_content text-center">
                <h2 data-aos="fade-up" data-aos-duration="1600">Tentang Skybook</h2>
...
<section class="about_area p_60">
    <div class="container">
        <div class="main_title">
            <h2 data-aos="fade-up" data-aos-duration="1600" style="font-size: 33px !important;">Tentang Skybook - Web Edukasi</h2>
            <p data-aos="fade-up" data-aos-duration="1800">Skybook adalah Web Edukasi yang dibuat oleh Lusi Elsa Maylana. Website
                ...
                kosong atau pun keadaan yang tidak terduga apapun karena Skybook dapat diakses dimana saja dan
                kapan saja.
            </p>
        </div>
        <div class="row about_inner">
                ...
                <div class="accordion" id="accordionExample">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body">
                                Mewujudkan Website Untuk Memudahkan Proses Pembelajaran
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                               1. Menjadikan website membantu proses pembelajaran secara interaktif.<br> 
                               2. Menjadikan website skybook sebagai sarana mediapembelajaran.
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                            <div class="card-body">
                               Menjadi inovasi media pembelajaran yang mengikuti perkembangan era modern yang dapat di gunakan dalam jangka Panjang, dan memotivasi pendidik untuk lebih meningkatkan kreatifitas khususnya dalam bidang teknologi pembelajaran jarak jauh.
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapsefour" class="collapse" aria-labelledby="headingfour" data-parent="#accordionExample">
                            <div class="card-body">
                              1. Menjadi inovasi media pembelajaran yang mengikuti perkembangan era modern yang dapat di gunakan dalam jangka Panjang, dan memotivasi pendidik untuk lebih meningkatkan kreatifitas khususnya dalam bidang teknologi pembelajaran jarak jauh.<br>
                              2. Memudahkan dan meningkatkan interaksi antara pendidik dengan peserta didik dalam proses pembelajaran.<br>
                              3. Meminimalisir dampak negatife dari penggunaan internet oleh peserta didik baik pada saat lingkungan sekolah atau diluar sekolah.
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="video_area" id="video">
                    <img class="img-fluid" src="<?= base_url('assets/') ?>img/12345.jpg" alt="" />
                    <a class="popup-youtube" href="https://www.youtube.com/watch?v=SS06UdKZsi0">
